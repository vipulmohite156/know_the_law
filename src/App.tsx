...
const aiImpactAnalysisByChangeId: Record<string, AIImpactAnalysis> = {
  'RBI-KYC-001': {
    businessAreas: [
      'Retail Banking',
      'Branch Operations',
    ...
    risk: 'Critical',
    confidence: '94%',
    recommendedAction: 'Confirm risk-based CDD changes and branch rollout plan',
  },
  'RBI-DL-002': {
    businessAreas: [
      'Digital Lending',
    ...
    risk: 'High',
    confidence: '91%',
    recommendedAction: 'Validate lending-partner inventory and borrower disclosure evidence',
  },
  'RBI-CYBER-003': {
    businessAreas: [
    ...
    risk: 'High',
    confidence: '93%',
    recommendedAction: 'Gap-assess SOC monitoring, incident playbooks, and board reporting',
  },
  'RBI-UPI-004': {
    businessAreas: [
      'Payments',
    ...
    risk: 'Medium',
    confidence: '89%',
    recommendedAction: 'Publish updated exception matrix and reconcile dispute SLAs',
  },
  'SEBI-MF-001': {
    businessAreas: [
      'Investment Products',
    ...
    policy: 'Investment Product Governance Policy',
    control: 'Investor disclosure review and product communication approval',
    owner: 'Legal',
    deadline: '15 Sep 2026',
    risk: 'High',
    confidence: '92%',
    recommendedAction: 'Review investor disclosures and update product communication controls',
  },
  'SEBI-CYBER-002': {
    businessAreas: [
      'Information Security',
    ...
    policy: 'Third-Party Risk and Information Security Policy',
    control: 'Intermediary cyber-risk assessment and resilience monitoring',
    owner: 'Information Security',
    deadline: '06 Oct 2026',
    risk: 'Critical',
    confidence: '95%',
    recommendedAction: 'Assess intermediary cyber controls and update third-party resilience evidence',
  },
  'IRDAI-CLAIMS-001': {
    businessAreas: [
      'Claims Operations',
    ...
    policy: 'Claims Handling and Customer Service Policy',
    control: 'Claims turnaround monitoring and service-level escalation',
    owner: 'Operations',
    deadline: '28 Sep 2026',
    risk: 'High',
    confidence: '90%',
    recommendedAction: 'Review claims SLA controls and establish escalation monitoring',
  },
};

const getAIImpactAnalysis = (change: Change): AIImpactAnalysis =>
  aiImpactAnalysisByChangeId[change.id] ?? {
    businessAreas: [change.category],
    ...
    confidence: 'N/A',
    recommendedAction: change.action,
  };
...
const initialChanges: Change[] = [
  ...
  },
  {
    ...
    category: 'India / Investment Disclosures',
    policy: 'Investment Product Governance Policy',
    control: 'Product disclosure review and investor communication approval',
    severity: 'High',
    deadline: '15 Sep 2026',
    owner: 'Legal',
    action: 'Review fund disclosures and evidence approval for customer-facing updates',
    status: 'Needs review',
    audit: [],
  },
  {
    ...
    regulator: 'Securities and Exchange Board of India (SEBI)',
    category: 'India / Securities Cyber Risk',
    policy: 'Third-Party Risk and Information Security Policy',
    control: 'Broker and custodian cyber-risk assessment and incident reporting',
    severity: 'Critical',
    deadline: '06 Oct 2026',
    owner: 'Information Security',
    action: 'Complete intermediary risk attestations and validate escalation evidence',
    status: 'In progress',
    audit: [],
  },
  {
    ...
    category: 'India / Insurance Claims',
    policy: 'Claims Handling and Customer Service Policy',
    control: 'Claims acknowledgement, escalation, and settlement SLA monitoring',
    severity: 'High',
    deadline: '28 Sep 2026',
    owner: 'Operations',
    action: 'Reconcile claims SLA reports and update escalation procedures',
    status: 'Needs review',
    audit: [],
  },
  {
    ...
    regulator: 'Insurance Regulatory and Development Authority of India (IRDAI)',
    category: 'India / Insurance Data Governance',
    policy: 'Data Governance and Privacy Policy',
    control: 'Policyholder data access review and retention evidence',
    severity: 'Medium',
    deadline: '19 Oct 2026',
    owner: 'Compliance',
    action: 'Validate data-retention inventory and policyholder access review records',
    status: 'Ready',
    complianceApproved: true,
    audit: [],
  },
...
const App: React.FC<ShellAppProps> = () => {
  ...
  const aiAnalysis = selected ? getAIImpactAnalysis(selected) : null;
  ...
  const renderDashboard = () => (
    <>
      ...
      <div style={css.banner}>
        Demo / Mock Data — Illustrative compliance records.
        Not real current regulatory notifications.
      </div>
              ...
              {aiLoading ? (
                ...
                <div style={css.grid}>
                  <div>
                    ...
                    <div style={css.value}>
                      {aiAnalysis?.businessAreas.map((area) => (
                  ...
                  <div>
                    ...
                    <div style={css.value}>
                      Owner: {aiAnalysis?.owner}
                      <br />
                      Deadline: {aiAnalysis?.deadline}
                      <br />
                      Risk: <strong>{aiAnalysis?.risk}</strong>
                      <br />
